...
class Event_model extends CI_Model {
	...
	public function viewportfolio_details($tab,$where)
	{
		$this->db->select("*")
				 ->distinct()
				/* ->from("event_details")*/
				 ->from("portfolio_gallery as evd")
				 ->join("client as evt","evd.partyid=evt.client_id","inner")
				 ->group_by("evd.galleryid")
				->where("evd.partyid",$where);
				/*->where("parent_cateid",$where);*/
