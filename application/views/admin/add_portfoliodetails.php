...
<div id="page-wrapper">
	<div class="main-page">
		<div class="forms">
			<h2 class="title1">Manage Portfolio Gallery</h2>
			<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
				<div class="form-title">
				<h4>Add Portfolio Gallery Media</h4>
				</div>
				<div class="form-body">
						...
						<form  action="<?php echo site_url()?>/Client/inserteventdetails" method="post" enctype="multipart/form-data" id="Video" style="display:none;">
						<?php if(isset($_GET['id']))
						{?>
							<input type="hidden" value="<?php echo $_GET['id']; ?>" name="mainid">
					<?php } ?>
					...
					<form id="photo" style="display:none;" action="<?php echo site_url()?>/Client/inserteventphotodetails" method="post" enctype="multipart/form-data">
							<?php if(isset($_GET['id']))
						{?>
							<input type="hidden" value="<?php echo $_GET['id'] ?>" name="mainid">
					<?php } ?>
						...
						<div id="dropzonewidget" class="dropzone" data-url="<?php echo site_url(); ?>Client/uploadfiles" required>
						</div> 
						</div> 
							<?php if(form_error('event'))
								{?>
					...
					<form id="eventurl" style="display: none;" action="<?php echo site_url()?>/Client/inserteventurldetails" method="post" enctype="multipart/form-data">
						<div class="form-group"> 
								<?php if(isset($_GET['id']))
						{?>
							<input type="hidden" value="<?php echo $_GET['id'] ?>" name="mainid">
