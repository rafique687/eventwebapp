    ...
    <div id="page-wrapper">
      <div class="main-page">
        <div class="tables" style="margin-top:0px;">
          ...
          <h2 class="title1"><?php if(isset($unapprove)){ echo 'Unapprove Client';} else { echo 'New Cleint';} ?></h2>
              ...
              <tbody> 
               ...
               //  echo "<pre>"; print_r($team);exit;
                ...
                <!--   <td>
                  ...
                  <td>
                      <?php if($prod['verifystatus']==1){ echo 'uproved';} else{ echo 'Due Client';}?>
                      <select id="aprove" onchange="updatt(this.value,<?php echo $prod['client_id'];?>);">
                  ...
                  <td>
                     <a href="<?php echo site_url()?>/client/clientdetails?id=<?php echo $prod['client_id'];?>" class="btn btn-success"><i class="fa fa-eye"></i>
...
$('#aprove').on("change",function(){
 
  var sts  = $("#aprove").val();
  var client =("#idd")
  var confirmalert = confirm("Are you sure Update Status");
  if (confirmalert == true) {
   // AJAX Request
   $.ajax({
        url: "<?php echo base_url("client/jqueryaprove");?>",
        type: "POST",
        data: {
            type: 1,
            sts: sts,
