...
$(document).ready(function(){ 
    $("#pcate").change(function () {
        var gender = $("#pcate").val();
            jQuery.ajax({
            url: "<?php echo site_url()?>/Packages/jquerysubcate?id="+gender,
            type: "GET",
            data: "id = "+ gender,
            dataType: "html",
			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/packages/inser_edititem" method="post" method="post" enctype="multipart/form-data"> 
								<input type="hidden" name="gett" value="<?php echo $editid?>">
								<div class="form-group"> 
									<label for="exampleInputEmail1">Package Name</label> 
									<input type="text" class="form-control" id="" name="product_name" value="<?php echo $product['package_name'];?>" > 
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control"  name="caption" required="" value="<?php echo $product['caption']; ?>" > 
									<?php if(form_error('caption'))
										{?>
										<div class="custom"> <?php echo strip_tags(form_error('caption'));?></div>
								 <?php  };?>
								</div>
								<div class="form-group"> 
									<label for="exampleInputEmail1">Price</label> 
									<input type="text" class="form-control"  name="price" required="" value="<?php echo $product['package_price']; ?>" > 
								...
								<input type="hidden" name="oldpic" value="<?php echo $product['image']?>">
								<?php if(isset($error))
										{?>
												<div class="custom"> <?php echo strip_tags(form_error($imgerror['error']));?></div>
                    ...
                    <div class="form-group col-12">
				               ...
				               <div id="dropzonewidget" class="dropzone" data-url="<?php echo site_url(); ?>Packages/uploadfiles">
...
$('.idd').on("click",function(){
  ...
  if (confirmalert == true) {
	 // AJAX Request
	 $.ajax({
				url: "<?php echo base_url("packages/delimage");?>",
				type: "POST",
				data: {
						cateid: cateid,
						imgnam: imgname,
