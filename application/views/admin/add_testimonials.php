			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/Testimonials/insert" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Company Name</label> 
									<input type="text" class="form-control" id="" name="product_name" placeholder="Company Name" required="" value="<?php echo set_value('product_name'); ?>" > 
								...
								<div class="form-group"> 
								 <label>Status</label>
                        				<select class="form-control" name="stockstatus" required="">
                                        	<option <?php if(set_value('status')==1){ echo "selected";}?> value="1">Active</option>
                           					<option <?php if(set_value('status')==0){ echo "selected";}?>  value="2">Inactive</option>
                        				</select>
                        				<?php if(isset($error))
										{?>
								...
								<div class="form-group">
									<label>Review</label>
									<textarea class="form-control" rows="3" placeholder="Enter Product Review" required="" name="des" value="<?php echo set_value('des'); ?>"></textarea>
				            ...
				            <div id="dropzonewidget" class="dropzone" data-url="<?php echo site_url(); ?>Testimonials/uploadfiles">
				</div> 
				</div>
