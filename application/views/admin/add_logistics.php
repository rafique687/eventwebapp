...
<!-- main content start-->
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h2 class="title1">Manage Logistics</h2>
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/Services/logisticinsert" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Logistics Name</label> 
									<input type="text" class="form-control" id="" name="product_name" placeholder="Logistics Name" required="" value="<?php echo set_value('product_name'); ?>" > 
								...
								<div class="form-group">
									...
									<textarea class="form-control" rows="3" placeholder="Enter Logistics  Description" required="" name="des" value="<?php echo set_value('des'); ?>">
									</textarea>
