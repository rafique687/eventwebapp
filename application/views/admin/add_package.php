			...
			<div class="main-page">
				<div class="forms">
					...
					<div class="form-grids row widget-shadow" data-example-id="basic-forms"> 
						...
						<div class="form-body">
							<form  action="<?php echo site_url()?>/packages/insert_package" method="post" enctype="multipart/form-data"> 
								<div class="form-group"> 
									<label for="exampleInputEmail1">Package Name</label> 
									<input type="text" class="form-control" id="" name="product_name" placeholder="Package Name" required="" value="<?php echo set_value('product_name'); ?>" > 
								...
								<div class="form-group"> 
									...
									<input type="text" class="form-control"  name="caption" placeholder="Caption" required="" value="<?php echo set_value('caption'); ?>" > 
								...
								<div class="form-group">
									...
									<input type="text" name="price"class="form-control" rows="3" placeholder="Enter Price" required=""  value="<?php echo set_value('price'); ?>">
									</textarea>
