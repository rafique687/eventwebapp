          ...
          <h1>
            <a class="navbar-brand" href="<?php echo base_url()?>dashboard/mydashboar">
             ...
             <!--  <?php echo $sessiontrue=$this->session->userdata('Site_name');?> -->
              <img src="<?php echo base_url().'settingpic/'.$sessiontrue=$this->session->userdata('logo');?>" style="width: 100%; height: 100%;"/></span>
              <span class="dashboard_text"></span>
            </a>
          </h1>
          </div>
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu"  style="overflow: scroll; height: 570px;">
             ...
             <li class="treeview">
              ...
              <li class="treeview">
                <a href="<?php echo site_url()?>/Services/logistics">
                <i class="glyphicon glyphicon-th-list"></i>
               ...
               <li class="treeview">
                <a href="<?php echo site_url()?>/Packages/ourpackage">
                <i class="glyphicon glyphicon-th-list"></i>
           ...
           <!--    <li class="treeview">
                ...
                <i class="fa fa-users"></i>
                    <span>Manage Due Client</span>
                </a>
              </li>
              <li class="treeview">
                <a href="<?php echo site_url()?>/Client/approved">
                <i class="fa fa-users"></i>
                    <span>Manage Approved Client</span>
                </a>
              </li> -->
               <!-- <li class="treeview">
             ...
             <li class="treeview">
                <a href="<?php echo site_url('contact/viewnews')?>">
                  <i class="glyphicon glyphicon-envelope"></i>
                <span>News Lettet</span>
                </a>
              </li>
              <li class="treeview">
                <a href="<?php echo site_url('contact/contactforminquery')?>">
                  <i class="glyphicon glyphicon-envelope"></i>
                <span>Contact Inquery</span>
                </a>
              </li>
              <li class="treeview">
                <a href="<?php echo site_url('contact/commaninquery')?>">
                  <i class="glyphicon glyphicon-envelope"></i>
                <span>Comman Inquery</span>
                </a>
              </li>
              ...
              <li class="treeview">
                ...
                <ul class="treeview-menu">
                   <li>
                    <a href="<?php echo site_url()?>/client/approved">
                    <i class="fa fa-angle-right"></i>Ongoing
                    </a>
                  </li>
                  <li>
                    <a href="<?php echo site_url()?>/client/unapprove">
                    <i class="fa fa-angle-right"></i>Unapprove
                    </a>
                  </li>
               ...
               <li class="treeview">
                 <a href="<?php echo site_url()?>/client/portfolio">
                    <i class="fa fa-users"></i>Portfolio
                    </a>
              ...
              <!--      <li>
                    <a href="<?php echo site_url()?>/Section/view_banner"><i class="fa fa-angle-right"></i>Banner</a></li> -->
